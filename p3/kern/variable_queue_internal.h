/** @file variable_queue_internal.h
 *
 *  @brief Generalized queue module for data collection, but declared as static
 *  	   so each data structure is private to the particular source file
 *  	   using them.
 *
